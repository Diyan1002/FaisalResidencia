...
export default function FaisalResidencia() {
  return (
    <section className="bg-[#e5dfd1] py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-20">
      ...
      {/* Paragraph 1 */}
      <p className="text-[#2c2c2c] leading-relaxed font-poppins text-justify text-sm sm:text-base mb-4 sm:mb-6 max-w-4xl mx-auto">
      ...
      {/* Paragraph 2 */}
      <p className="text-[#2c2c2c] leading-relaxed font-poppins text-justify text-sm sm:text-base mb-8 sm:mb-10 max-w-4xl mx-auto">
